...
assert.equal(channelDefinitions.find(row => row.provider === "meta").name, "Facebook + Instagram");
assert.equal(channelDefinitions.find(row => row.provider === "meta").connectLabel, "Connect Facebook & Instagram");
assert.equal(channelDefinitions.find(row => row.provider === "instagram").connectLabel, "Connect Instagram only");
...
assert.match(component, /Which option should I choose/);
...
try {
  ...
  assert(html.includes("Connect Facebook &amp; Instagram")); assert(html.includes("Connect Instagram only"));
  assert(html.includes("Recommended")); assert(html.includes("Which option should I choose?"));
  ...
  assert(connectedHtml.includes("Manage connection")); assert(connectedHtml.includes("Reconnect")); assert(connectedHtml.includes("Disconnect"));

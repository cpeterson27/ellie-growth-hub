  ...
  return (
    <div className="page-dashboard discovery-page">
      ...
      <DashboardCard title="Filters" className="apollo-filter-panel" action={<span className="apollo-filter-count">{searchMode === "people" ? "People" : "Companies"}</span>}>
        ...
        <div className="apollo-search-actions"><div><strong>{searchMode === "people" ? "Apollo people" : "Apollo organizations"}</strong><span>{searchMode === "people" && peopleSearchRunsInApollo ? "Filtered results open in Apollo" : "New prospects return for review"}</span></div><Button size="sm" loading={searchingApollo} onClick={() => searchMode === "people" && peopleSearchRunsInApollo ? openApolloPeopleSearch() : runApolloSearch(1)}>{searchMode === "people" ? (peopleSearchRunsInApollo ? "Open in Apollo" : "Search people") : "Search organizations"}</Button></div>

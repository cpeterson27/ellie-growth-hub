  ...
  return (
    <div className="page-dashboard discovery-page">
      ...
      <DashboardCard title="Filters" className="apollo-filter-panel" action={<span className="apollo-filter-count">{searchMode === "people" ? "People" : "Companies"}</span>}>
        ...
        <div className="apollo-workflow-status" aria-live="polite"><span className={apolloPhase !== "ready" ? "is-complete" : ""}>Filters</span><span className={["searching","results","empty","importing","imported"].includes(apolloPhase) ? "is-active" : ""}>Search</span><span className={["results","importing","imported"].includes(apolloPhase) ? "is-active" : ""}>Review</span><span className={apolloPhase === "imported" ? "is-complete" : ""}>Import</span></div>

...
export default function CampaignLaunch() {
  ...
  return <div className="page-dashboard launch-page">
    <header className="launch-hero"><div><p className="page-eyebrow">Guided campaign launch</p><h1>Launch with confidence.</h1><p>Growth Operator keeps every required decision in order. Nothing sends until the test, template, and recipients are ready.</p></div><div className="launch-progress"><strong>{completed}/{steps.length}</strong><span>steps complete</span></div></header>

...
const fieldGroups = [
  ...
  { title: "Growth Operator activity", fields: ["Email status", "Research status", "Campaign assignments", "Last contacted", "Outreach history"] },
];
...
export default function CrmSetup() {
  ...
  return <div className="page-dashboard crm-config-page">
    <div className="page-header">
      <div><p className="page-eyebrow">CRM · Contact setup</p><h1 className="page-title">Contact fields</h1><p className="page-subtitle">Review what Growth Operator already stores and add business-specific information only when your team needs it.</p></div>
    ...
    <section className="crm-config-intro">
      <div><span>How CRM status works</span><h2>Growth Operator manages the operational workflow automatically.</h2></div>
    ...
    <section className="crm-field-layout">
      <div className="crm-built-in-fields">
        <header><p className="page-eyebrow">Included with Growth Operator</p><h2>Built-in contact record</h2><p>These fields already exist in the database and appear when information is available. They cannot be removed because imports, matching, outreach, and reporting depend on them.</p></header>
      ...
      <aside className="crm-custom-fields">
        <p className="page-eyebrow">Optional</p><h2>Custom fields</h2><p>Add a field only when this business needs information Growth Operator does not already store—for example “Preferred market” or “Membership level.”</p>

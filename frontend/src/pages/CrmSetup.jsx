...
const fieldGroups = [
  ...
  { title: "Ellie activity", fields: ["Email status", "Research status", "Campaign assignments", "Last contacted", "Outreach history"] },
];
...
export default function CrmSetup() {
  ...
  return <div className="page-dashboard crm-config-page">
    ...
    <section className="crm-config-intro">
      <div><span>How CRM status works</span><h2>Ellie manages the operational workflow automatically.</h2></div>
    ...
    <section className="crm-field-layout">
      <div className="crm-built-in-fields">
        <header><p className="page-eyebrow">Included with Ellie</p><h2>Built-in contact record</h2><p>These fields already exist in the database and appear when information is available. They cannot be removed because imports, matching, outreach, and reporting depend on them.</p></header>

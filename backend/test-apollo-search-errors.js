...
assert.deepStrictEqual(contactSearchDiagnostic({ status: 200, data: { people: [], pagination: { page: 1, per_page: 1, total_entries: 0, total_pages: 0 } } }), {
  endpoint: "/api/v1/mixed_people/api_search",
  status: 200,
  topLevelKeys: ["people", "pagination"],
  resultCount: 0,
  apolloCode: null,
  apolloMessage: null,

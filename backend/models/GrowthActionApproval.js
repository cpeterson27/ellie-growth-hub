...
const growthActionApprovalSchema = new mongoose.Schema({
  ...
  action: { type: String, enum: ["send_campaign", "archive_contacts", "apply_template", "add_crm_field", "import_linkedin_connections", "import_public_people", "update_contact_field", "save_business_memory", "execute_automation_action"], required: true },

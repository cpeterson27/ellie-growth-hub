/**
 * Eventbrite Sync History Model
 * Tracks each Eventbrite sync operation and its results
 */
...
module.exports = mongoose.model("EventbriteSyncHistory", syncHistorySchema);

...
const workspaceConfigSchema = new mongoose.Schema({
  ...
  appBranding: {
    ...
    surfaceMode: { type: String, enum: ["light", "dark", "system"], default: "light" },
  },
  publicSite: {
    ...
    heroOverline: { type: String, default: "Structured programs", maxlength: 160 }, heroTagline: { type: String, default: "Real people · practical work · accountable progress", maxlength: 300 },
    aboutEyebrow: { type: String, default: "Why Ellie Coaching", maxlength: 160 }, aboutTitle: { type: String, default: "Experience, perspective, and practical support.", maxlength: 300 },
    valuePropositions: { type: [{ _id: false, title: { type: String, maxlength: 160 }, body: { type: String, maxlength: 800 } }], default: [] },
    programsEyebrow: { type: String, default: "Programs", maxlength: 160 }, programsTitle: { type: String, default: "Choose the support that meets you where you are.", maxlength: 300 },
    journeyEyebrow: { type: String, default: "Your path", maxlength: 160 }, journeyTitle: { type: String, default: "From exploring a program to doing the work.", maxlength: 300 }, journeyCopy: { type: String, default: "Applying starts a conversation. Enrollment is not automatic or guaranteed.", maxlength: 1200 }, journeySteps: { type: [String], default: [] },
    eventEyebrow: { type: String, default: "Upcoming training", maxlength: 160 }, eventTitle: { type: String, default: "", maxlength: 300 }, eventSummary: { type: String, default: "", maxlength: 1200 }, eventCtaLabel: { type: String, default: "Event details", maxlength: 80 },
    headingFont: { type: String, enum: ["editorial", "modern", "classic"], default: "editorial" }, bodyFont: { type: String, enum: ["modern", "classic"], default: "modern" }, baseFontSize: { type: Number, min: 14, max: 20, default: 16 }, headingScale: { type: Number, min: 0.8, max: 1.2, default: 1 },
  ...
  ai: {
    ...
    agentEnabled: {
      jarvis: { type: Boolean, default: true }, lead: { type: Boolean, default: true }, social: { type: Boolean, default: true }, sales: { type: Boolean, default: true },
      content: { type: Boolean, default: true }, coaching: { type: Boolean, default: true }, research: { type: Boolean, default: true }, system: { type: Boolean, default: true },
    },
  },
  socialAi: {
  ...
  automationPolicy: {
    ...
    conversationCooldownMinutes: { type: Number, default: 15, min: 0, max: 1440 },
    duplicateWindowMinutes: { type: Number, default: 1440, min: 1, max: 43200 },
  },
  discoveryTemplates: {
    type: [{
      _id: false,

...
const schema = new mongoose.Schema({
  ...
  coachProfileId: { type: mongoose.Schema.Types.ObjectId, ref: "CoachProfile", required: true, index: true }, coachUserId: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true, index: true }, contactId: { type: mongoose.Schema.Types.ObjectId, ref: "Contact", required: true, index: true },
  ...
  status: { type: String, enum: ["pending", "approved", "paid", "reversed"], default: "pending", index: true }, calculatedAt: { type: Date, default: Date.now, required: true },
